...
void UpdateAdcData()
{
	...
	switch(GetChannelID())
		...
		case 1:
//			if(tSpiData.Data0<11600)
//			s_tReg->Ac115VaCh1OutputVoltage = tSpiData.Data0;
//			if(tSpiData.Data1<11600)
//			s_tReg->Ac115VbCh1OutputVoltage = tSpiData.Data1;
//			if(tSpiData.Data2<11600)
//			s_tReg->Ac115VcCh1OutputVoltage = tSpiData.Data2;
		...
		case 2:
//			if(tSpiData.Data0<11600)
//			s_tReg->Ac115VaCh2OutputVoltage = tSpiData.Data0;
//			if(tSpiData.Data1<11600)
//			s_tReg->Ac115VbCh2OutputVoltage = tSpiData.Data1;
//			if(tSpiData.Data2<11600)
//			s_tReg->Ac115VcCh2OutputVoltage = tSpiData.Data2;
		...
		case 3:
//			if(tSpiData.Data0<11600)
//			s_tReg->Ac115VaCh3OutputVoltage = tSpiData.Data0;
//			if(tSpiData.Data1<11600)
//			s_tReg->Ac115VbCh3OutputVoltage = tSpiData.Data1;
//			if(tSpiData.Data2<11600)
//			s_tReg->Ac115VcCh3OutputVoltage = tSpiData.Data2;
		...
		case 4:
//			if(tSpiData.Data0<11600)
//			s_tReg->Ac115VaCh4OutputVoltage = tSpiData.Data0;
//			if(tSpiData.Data1<11600)
//			s_tReg->Ac115VbCh4OutputVoltage = tSpiData.Data1;
//			if(tSpiData.Data2<11600)
//			s_tReg->Ac115VcCh4OutputVoltage = tSpiData.Data2;
		...
		case 5:
//			if(tSpiData.Data0<11600)
//			s_tReg->Ac115VaCh5OutputVoltage = tSpiData.Data0;
//			if(tSpiData.Data1<11600)
//			s_tReg->Ac115VbCh5OutputVoltage = tSpiData.Data1;
//			if(tSpiData.Data2<11600)
//			s_tReg->Ac115VcCh5OutputVoltage = tSpiData.Data2;
		...
		case 6:
//			if(tSpiData.Data0<11600)
//			s_tReg->Ac115VaCh6OutputVoltage = tSpiData.Data0;
//			if(tSpiData.Data1<11600)
//			s_tReg->Ac115VbCh6OutputVoltage = tSpiData.Data1;
//			if(tSpiData.Data2<11600)
//			s_tReg->Ac115VcCh6OutputVoltage = tSpiData.Data2;
