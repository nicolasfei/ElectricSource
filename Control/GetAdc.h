...
#define AC_115V_OUTV_ALL_A_FACTOR			(28.714)
#define AC_115V_OUTV_ALL_B_FACTOR			(30.182)
#define AC_115V_OUTV_ALL_C_FACTOR			(30.315)

#define AC_115V_OUTV_CHANNEL_A_FACTOR	(28.714)
#define AC_115V_OUTV_CHANNEL_B_FACTOR	(30.182)
#define AC_115V_OUTV_CHANNEL_C_FACTOR	(30.315)

#define AC_115V_OUTI_ALL_A_FACTOR		(1)
#define AC_115V_OUTI_ALL_B_FACTOR		(1)
#define AC_115V_OUTI_ALL_C_FACTOR		(1)

#define AC_115V_OUTI_CHANNEL_A_FACTOR	(1)
#define AC_115V_OUTI_CHANNEL_B_FACTOR	(1)
#define AC_115V_OUTI_CHANNEL_C_FACTOR	(1)

#define AC_115V_INV_A_FACTOR	(30.539)
#define AC_115V_INV_B_FACTOR	(31.071)
#define AC_115V_INV_C_FACTOR	(30.062)
...
#define AC_115V_OUTV_ALL_A_B				(-6323+200)
#define AC_115V_OUTV_ALL_B_B				(-6905.1+200)
#define AC_115V_OUTV_ALL_C_B				(-7243.2+200)

#define AC_115V_OUTV_CHANNEL_A_B		(-6323+200)
#define AC_115V_OUTV_CHANNEL_B_B		(-6905.1+200)
#define AC_115V_OUTV_CHANNEL_C_B		(-7243.2+200)
...
#define AC_115V_INV_A_B		(-7092.5)
#define AC_115V_INV_B_B		(-7467.9)
#define AC_115V_INV_C_B		(-7027.3)
